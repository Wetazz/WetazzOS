  ...
  return (
    <div className="max-w-md mx-auto px-6 py-24">
      ...
      <form onSubmit={submit} className="border border-white/10 p-8 space-y-4" data-testid="login-form">
        ...
        <button data-testid="login-submit" disabled={busy} className="w-full bg-[#B5FF2E] hover:bg-[#C8FF5A] py-3 font-bold uppercase tracking-widest disabled:opacity-50">{busy?"Signing in...":"Sign in"}</button>
        <div className="text-sm text-zinc-400 text-center">No account? <Link data-testid="login-signup-link" to="/signup" className="text-[#B5FF2E]">Sign up</Link></div>
